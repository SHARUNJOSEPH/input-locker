...
<p align="center">
  ...
  <a href="https://github.com/SHARUNJOSEPH/input-locker/releases">
    <img src="https://img.shields.io/badge/🏷️%20All%20Releases-v0.2.4-312E81?style=for-the-badge&logo=github&logoColor=white" alt="All Releases" />
  </a>
</p>
...
| :--- | :---: | :---: | :--- |
| **Input Locker Windows Installer** | Setup Wizard (.exe) | Windows 10 / 11 (64-bit) | [💿 **Download `InputLocker-Setup-v0.2.4.exe`**](https://github.com/SHARUNJOSEPH/input-locker/releases/latest/download/InputLocker-Setup-v0.2.4.exe) |
...
| **Input Locker Portable Bundle** | `.zip` | Windows 10 / 11 (64-bit) | [📦 **Download `InputLocker-v0.2.4-Windows-x64.zip`**](https://github.com/SHARUNJOSEPH/input-locker/releases/latest/download/InputLocker-v0.2.4-Windows-x64.zip) |
